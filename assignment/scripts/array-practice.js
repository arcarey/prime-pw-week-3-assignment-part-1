...
favoriteFoods = ["eggs", "clam chowder", "milk"];
...
favoriteFoods.push("chicken wings");
...
console.log(
  "I've changed my soup preference. Now my favorite foods are:",
  favoriteFoods
);
...
console.log(
  "My favorite foods sorted in reverse alphabetical order are:",
